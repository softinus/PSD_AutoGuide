    ...
    public partial class frmMain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                txtLayerCount.Text = m_File.Layers.Count.ToString();
                txtRescount.Text = m_File.ImageResources.Count.ToString();
                txtDataCount.Text = m_File.ImageData.Length.ToString();
                txtRows.Text = m_File.Rows.ToString();
                txtDepth.Text = m_File.Depth.ToString(); 
